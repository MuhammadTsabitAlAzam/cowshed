...
class _RegisterPageState extends State<RegisterPage> {
  ...
  User createUserToRegister() {
    ...
    if (_selectedRole == 'Puskeswan') {
      user.lat = double.parse(RegisterPage._lat.text);
      user.lng = double.parse(RegisterPage._lng.text);
    }
  ...
  Future<void> registerUser(BuildContext context) async {
    if (RegisterPage._nama.text.isEmpty ||
        ...
        (_selectedRole == 'Puskeswan' && RegisterPage._lat.text.isEmpty) ||
        (_selectedRole == 'Puskeswan' && RegisterPage._lng.text.isEmpty)
    )
    {
            ...
            child: Column(
                children: [
                  ...
                  Visibility(
                    ...
                    child: CommonTextField(label: 'Latitude*', controller: RegisterPage._lat),
                  ),
                  SizedBox(height: 15,),
                  Visibility(
                    visible: _selectedRole == 'Puskeswan',
                    child: CommonTextField(label: 'Longitude*', controller: RegisterPage._lng),
                  ),
                  SizedBox(height: 35,),
